...
export default function AddEventTypeForm({ onSuccess, onCancel }: AddEventTypeFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(API_ENDPOINTS.EVENT_TYPES.CREATE, {
        method: 'POST',
        headers: {
      ...
      showSuccessToast('Event type created successfully', 'Success');
      onSuccess();
    } catch (err) {
