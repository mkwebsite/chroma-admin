...
export default function EventTypesTable({ eventTypes, isLoading, onEdit, onDelete }: EventTypesTableProps) {
  if (isLoading) {
    return (
      <div className="flex items-center justify-center py-12">
        <div className="text-center">
          <div className="inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-gray-900 dark:border-white"></div>
          <p className="mt-4 text-gray-600 dark:text-gray-400">Loading event types...</p>
        </div>
      </div>
    );
  }
  ...
  if (eventTypes.length === 0) {
    return (
      <div className="flex items-center justify-center py-12">
        <p className="text-gray-600 dark:text-gray-400">No event types found</p>
      </div>
    );
  }
