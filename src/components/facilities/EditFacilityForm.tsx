...
export default function EditFacilityForm({ facility, onSuccess, onCancel }: EditFacilityFormProps) {
  ...
  // Update form data when facility changes
  useEffect(() => {
    setFormData({
      name: facility.name || '',
      description: facility.description || '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(API_ENDPOINTS.FACILITIES.UPDATE(facility._id), {
        method: 'PATCH',
        headers: {
      ...
      showSuccessToast('Facility updated successfully', 'Success');
      onSuccess();
    } catch (err) {
