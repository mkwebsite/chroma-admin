...
interface DeletePropertyTypeConfirmProps {
...
export default function DeletePropertyTypeConfirm({
  propertyType,
  onConfirm,
  onCancel,
  isDeleting = false,
}: DeletePropertyTypeConfirmProps) {
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-end w-full gap-3 mt-6">
        ...
        >
          {isDeleting ? 'Deleting...' : 'Delete Property Type'}
        </button>
      </div>
    </div>
  );
