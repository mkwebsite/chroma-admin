...
interface DeleteMenuRouteConfirmProps {
  menuRoute: MenuRoute;
  onConfirm: () => void;
  onCancel: () => void;
  isDeleting?: boolean;
...
export default function DeleteMenuRouteConfirm({
  menuRoute,
  onConfirm,
  onCancel,
  isDeleting = false,
}: DeleteMenuRouteConfirmProps) {
  return (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-sm leading-6 text-gray-500 dark:text-gray-400">
          Are you sure you want to delete the menu route{' '}
      ...
      <div className="flex items-center justify-end w-full gap-3 mt-6">
        ...
        >
          {isDeleting ? 'Deleting...' : 'Delete Menu Route'}
        </button>
      </div>
    </div>
  );
