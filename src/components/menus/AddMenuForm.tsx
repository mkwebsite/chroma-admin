...
export default function AddMenuForm({ onSuccess, onCancel }: AddMenuFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(API_ENDPOINTS.MENUS.CREATE, {
        method: 'POST',
        headers: {
      ...
      showSuccessToast('Menu created successfully', 'Success');
      setFormData({
        name: '',
        status: 'active',
      });
