...
export default function EditRoomTypeForm({ roomType, onSuccess, onCancel }: EditRoomTypeFormProps) {
  ...
  // Update form data when roomType changes
  useEffect(() => {
    setFormData({
      name: roomType.name || '',
      description: roomType.description || '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(API_ENDPOINTS.ROOM_TYPES.UPDATE(roomType._id), {
        method: 'PATCH',
        headers: {
      ...
      showSuccessToast('Room type updated successfully', 'Success');
      onSuccess();
    } catch (err) {
