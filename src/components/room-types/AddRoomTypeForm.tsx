...
export default function AddRoomTypeForm({ onSuccess, onCancel }: AddRoomTypeFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(API_ENDPOINTS.ROOM_TYPES.CREATE, {
        method: 'POST',
        headers: {
      ...
      showSuccessToast('Room type created successfully', 'Success');
      onSuccess();
    } catch (err) {
